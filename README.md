...
`green` is a tool designed to **provide structure** and a **set of patterns**
...
[View the example application](https://github.com/simpleweb/green-example) created with green
to get an idea of what `green init` does. The application is ready to be cloned down and ran
